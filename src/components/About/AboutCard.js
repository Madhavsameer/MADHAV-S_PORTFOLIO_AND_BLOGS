      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br /> I am a Final year student pursuing a B.tech degree in Computer Science
            Engineering from Centurion University, Paralakhemundi
            <br />
            Additionally, I am currently working on multiple projects in Web & Software development field
            <br />
            <br />
